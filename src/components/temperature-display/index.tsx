...
export const TemperatureDisplay = ({ location, temperature, isControlled, isLoading }: TemperatureDisplayProps) => {

    if (isLoading) {
        return (<Flex padding="8" alignItems="center" justifyContent="center"><Spinner></Spinner></Flex>)
    }
